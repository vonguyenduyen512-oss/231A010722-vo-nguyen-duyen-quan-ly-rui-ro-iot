...
2. Mở tệp `results/Risk_Register_va_Ma_tran_Rui_ro.xlsx`:
   - **Sheet 6.1:** Danh mục tài sản.
   - **Sheet 6.2:** Risk Register.
   - **Sheet 6.3:** Ma trận rủi ro 5×5.
   - **Sheet 6.4:** Kế hoạch xử lý rủi ro.
   - **Sheet 6.5:** Checklist kiểm tra bảo mật.
3. Xem file `slides/231A010722_SlideTrinhBay_DeTai35.pptx` để trình bày nội dung tóm tắt.
4. Tham khảo danh sách tài liệu trong `references/README.md`.
