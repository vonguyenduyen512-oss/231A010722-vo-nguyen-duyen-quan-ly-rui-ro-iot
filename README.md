...
└── references/
    └── link_nguon.md
Hướng dẫn sử dụng
Đọc báo cáo trong thư mục report/.
Mở tệp results/Risk_Register_va_Ma_tran_Rui_ro.xlsx:
...
Xem file slides/231A010722_SlideTrinhBay_DeTai35.pptx để trình bày nội dung tóm tắt.
Tham khảo danh sách tài liệu trong references/link_nguon.md.
Kết quả chính
